...
export const ScanModal: React.FC<ScanModalProps> = ({
  ...
  const confirmationText =
    language === "es"
      ...
      : "Every populated field is a reviewable suggestion from AI image analysis or barcode lookup. Product name, category, cost, and expiry are unverified suggestions even after quantity and unit are confirmed; unknown values stay blank. Both quantity and unit must be confirmed before this candidate can be added. Each confirmation applies only to the quantity or unit value currently shown. You must explicitly confirm both before the item can be added to the pantry.";
